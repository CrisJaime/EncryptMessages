...
modules.key.crear_archivo_cambios(finalPixels, totalFilas, ancho, totalPixelsText)  # Save changes in a file

# --- Create Modified Image ---
ImgMod = modules.createImg.crear_imagen(finalPixels, img, ancho, alto)  # Create a new image with modified pixels
